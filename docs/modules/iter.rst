...
iterate
~~~~~~~~~~
The :code:`iterate` function loops through collections (list, dict, tuple, set) and executes the provided function on non-collection data types. The :code:`iterate` function is used by :code:`spine.fmt.sub.sub_value` to perform string replacements.
